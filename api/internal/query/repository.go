...
type TraceRepository interface {
	...
	GetTrace(ctx context.Context, traceID string, workspaceIDs []string) (*model.Trace, error)
	GetSpans(ctx context.Context, traceID string, workspaceIDs []string) ([]model.Span, error)
}
