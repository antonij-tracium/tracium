INSERT INTO tracium.spans (trace_id, span_id, name, start_time_ms, end_time_ms, workspace_id, user_id, workflow_name, model, model_normalized, cost_usd, input_tokens, output_tokens, source)
