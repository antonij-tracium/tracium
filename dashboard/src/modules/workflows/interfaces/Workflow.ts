// API response shape for GET /v1/metrics/workflows — one active workflow over the
...
// error_rate is the fraction of the workflow's runs that errored (0–1); trend is
